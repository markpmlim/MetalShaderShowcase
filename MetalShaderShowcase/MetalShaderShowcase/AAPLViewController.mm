/*
 ...
 Abstract:
 View Controller for Metal Sample Code. Maintains a CADisplayLink timer that runs on the main thread and
 triggers rendering in AAPLView. Provides update callbacks to its delegate on the timer,
...
// Notifications need to be deallocated manually.
- (void) dealloc
{
