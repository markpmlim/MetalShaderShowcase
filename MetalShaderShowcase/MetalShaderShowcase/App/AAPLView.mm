...
// For NSView objects instantiated via xib file.
...
// called by the view controller renderPass method per frame update.
- (void) display
{
...
#ifdef TARGET_IOS
            drawableSize.width  *= _contentScaleFactor;
            drawableSize.height *= _contentScaleFactor;
#else
...
#else
// these 4 methods are overridden.
